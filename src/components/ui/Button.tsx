...
export const buttonBase =
  "inline-flex items-center justify-center gap-2 rounded-pill font-bold text-[15.5px] px-6 py-[15px] transition-opacity disabled:opacity-50 disabled:pointer-events-none active:opacity-90";
